...
export class Migration1772641418568 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "chat_groups" ("id" BIGSERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text, "created_by_user_id" bigint NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_99f0cb8163569cd32e8a16cbc9f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "messaging_messages" ("id" BIGSERIAL NOT NULL, "sender_user_id" bigint NOT NULL, "body" text NOT NULL, "message_type" character varying(50) NOT NULL DEFAULT 'text', "metadata" json, "edited_at" TIMESTAMP, "deleted_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "group_id" bigint, CONSTRAINT "PK_8432ff51154218cce49022d5e35" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "chat_group_members" ("id" BIGSERIAL NOT NULL, "user_id" bigint NOT NULL, "role" character varying(50), "joined_at" TIMESTAMP NOT NULL DEFAULT now(), "last_read_message_id" bigint, "muted_until" TIMESTAMP, "status" character varying(50), "group_id" bigint, CONSTRAINT "PK_52d8d185c5d381d83161254ebe2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
