...
export class ChatGroupMemberMapper {
    static toDomain(raw: ChatGroupMemberEntity): ChatGroupMember {
        ...
        domainEntity.lastReadMessageId = raw.lastReadMessageId ? Number(raw.lastReadMessageId) : null;
    ...
    static toPersistence(domainEntity: ChatGroupMember): ChatGroupMemberEntity {
        ...
        persistenceEntity.lastReadMessageId = domainEntity.lastReadMessageId ? Number(domainEntity.lastReadMessageId) : null;
