...
export class ChatGroupMembersController {
    constructor(private readonly chatGroupMembersService: ChatGroupMembersService) { }
    ...
    addMember(@Body() addUserIntoGroupDto: AddUserIntoGroupDto): Promise<ChatGroupMemberResponseDto> {
